...
var aboutMeContent = [
	'<p>Hello and warm greetings from Amit. Thanks a lot for stopping by his lovingly handcrafted site. This website is an expression of his digital side and an open ground for showcasing his acumen in various web technologies.</p>'
...
,	'<p>&nbsp;</p>'
,	'<p style="text-align:center;"><i class="icon ion-social-html5-outline"></i> <i class="icon ion-ios-heart-outline"></i> <i class="icon ion-social-css3-outline"></i> <i class="icon ion-ios-heart-outline"></i> <i class="icon ion-social-javascript"></i> <i class="icon ion-ios-heart-outline"></i> <i class="icon ion-social-nodejs"></i> <i class="icon ion-ios-heart-outline"></i> <i class="icon ion-social-python"></i></p>'
];
...
,	'<h2>A select few JavaScript ones</h2>'
...
,	'<p id="https://amitkumarsarangi.github.io/Scrawls-n-Scribbles-JS/Simple-Smooth-Scroller/main.html" style="cursor:pointer" onclick="displayProject(this.id)">&#10085; Simple Smooth Scroller</p>'
,	'<h2>A select few CSS ones</h2>'
...
,	'<p id="https://amitkumarsarangi.github.io/Scrawls-n-Scribbles-CSS/Youtube-Play-Pause-Button/main.html" style="cursor:pointer" onclick="displayProject(this.id)">&#10085; Youtube Play-Pause Button</p>'
...
,	'<p id="https://amitkumarsarangi.github.io/Build-a-Simon-Game/" style="color:#006400;cursor:pointer" onclick="displayProject(this.id)">&#10085; Build a Simon Game</p>'
,	'<p id="https://amitkumarsarangi.github.io/Build-a-Tic-Tac-Toe-Game/" style="color:#006400;cursor:pointer" onclick="displayProject(this.id)">&#10085; Build a Tic Tac Toe Game</p>'
,	'<p id="https://amitkumarsarangi.github.io/Build-a-Pomodoro-Clock/" style="color:#006400;cursor:pointer" onclick="displayProject(this.id)">&#10085; Build a Pomodoro Clock</p>'
,	'<p id="https://amitkumarsarangi.github.io/Build-a-JavaScript-Calculator/" style="color:#006400;cursor:pointer" onclick="displayProject(this.id)">&#10085; Build a JavaScript Calculator</p>'
...
,	'<p id="https://amitkumarsarangi.github.io/Scrawls-n-Scribbles-JS/Basic-Multiplication-Game/main.html" style="cursor:pointer" onclick="displayProject(this.id)">&#10085; Basic Multiplication Game<sup>(JS)</sup></p>'
...
,	'<hr style="margin:auto;padding:5px 0;width:95%;border-top:1px solid silver">'
,	'<p id="https://amitkumarsarangi.github.io/Scrawls-n-Scribbles-JS/" style="cursor:pointer" onclick="displayProject(this.id)">See All of the JavaScript ones</p>'
,	'<p id="https://amitkumarsarangi.github.io/Scrawls-n-Scribbles-CSS/" style="cursor:pointer" onclick="displayProject(this.id)">See All of the CSS ones</p>'
];

var algorithmsContent = [
	'<h1>Algorithms</h1>'
,	'<p id="https://medium.com/@sarangiamitkumar/freecodecamp-basic-algorithm-scripting-solutions-reverse-a-string-dafd3f21c172" style="cursor:pointer" onclick="openLinks(this.id)">&raquo; freeCodeCamp Basic Algorithm Scripting Solutions: Reverse a String</p>'
];
