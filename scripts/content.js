...
,	'<p id="https://amitkumarsarangi.github.io/Scrawls-n-Scribbles-JS/" style="cursor:pointer" onclick="openLinks(this.id)">See All of the JavaScript ones</p>'
,	'<p id="https://amitkumarsarangi.github.io/Scrawls-n-Scribbles-CSS/" style="cursor:pointer" onclick="openLinks(this.id)">See All of the CSS ones</p>'
];
