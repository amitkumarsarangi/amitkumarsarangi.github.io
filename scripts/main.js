...
var scribblesContent = [
					...
					,	'<p id="https://amitkumarsarangi.github.io/A-Javascript-Clock/" style="cursor:pointer" onclick="displayProject(this.id)">&#10085; A Javascript Clock <sub>(JavaScript | CSS3)</sub></p>'
					,	'<p id="https://amitkumarsarangi.github.io/A-Rotating-Pyramid/" style="cursor:pointer" onclick="displayProject(this.id)">&#10085; A Rotating Pyramid <sub>(CSS3)</sub></p>'
					,	'<p id="https://amitkumarsarangi.github.io/A-Rotating-Prism/" style="cursor:pointer" onclick="displayProject(this.id)">&#10085; A Rotating Prism <sub>(CSS3)</sub></p>'
					,	'<p id="https://amitkumarsarangi.github.io/A-Rotating-Cube/" style="cursor:pointer" onclick="displayProject(this.id)">&#10085; A Rotating Cube <sub>(CSS3)</sub></p>'
					...
					,	'<p id="https://amitkumarsarangi.github.io/A-Venice-Postcard/" style="cursor:pointer" onclick="displayProject(this.id)">&#10085; A Venice Postcard <sub>(CSS3 | HTML5)</sub></p>'
